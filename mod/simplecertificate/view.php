...
// ===== LIMITE DE EMISSÕES =====
$issues = $DB->count_records('simplecertificate_issues', [
    'userid' => $USER->id,
    'certificateid' => $certificate->id
]);

if ($issues >= 2 && !$canmanage) {
    echo $OUTPUT->header();
    echo $OUTPUT->notification('⚠️ Você já atingiu o limite de 2 downloads permitidos deste certificado.', 'error');
